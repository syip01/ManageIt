...
<head>
	...
	<!-- Title Page-->
	<title>ManageIt! Modify Groups</title>
                	            ...
                	            <div class="col-lg-6">
                    	            <div class="card">
                                    	...
                                    	<div class="card-body card-block">
                                    			<form:form action="${pageContext.request.contextPath}/addGroup" method="post" modelAttribute="userKey" class="form-horizontal">
    	            ...
    	            <div class="section__content section__content--p30">
        	            <div class="container-fluid">
            	            <div class="row">
								<div class="col-md-12">
                                	<!-- DATA TABLE -->
                                	<h3 class="title-5 m-b-35">Group List</h3>
                        	                    ...
                        	                    <tr class="tr-shadow">
                                        	        ...
                                        	        <td>
                                            	        <div class="table-data-feature">
                                                        	<button class="item" data-toggle="tooltip" data-placement="top" title="Update" type="button" onclick="location.href='${pageContext.request.contextPath}/updateGroup/${group.id}'" >
	                                                            <i class="zmdi zmdi-edit"></i>
	                                                        </button>
    	                                                    <button class="item" data-toggle="tooltip" data-placement="top" title="Delete" type="button" onclick="location.href='${pageContext.request.contextPath}/removeGroup/${group.id}'">
