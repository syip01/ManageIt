...
<head>
    ...
    <!-- Title Page-->
	<title>ManageIt! Update Group</title>
                	            ...
                	            <div class="col-lg-6">
                    	            <div class="card">
                                    	...
                                    	<div class="card-body card-block">
												<form:form action="${pageContext.request.contextPath}/confirmUpdateGroup" method="post" modelAttribute="userKey" class="form-horizontal">
												 <div class="form-group">
													<label for="id" class="form-control-label">Id:</label><br>
													<form:input type="text" path="id" id="id" class="form-control"
														placeholder="Enter Id" value="${group.id}" readonly="true"/><br><br>
	                                        	</div>													
	                                        	<div class="form-group">
													<label for="name" class="form-control-label">Name:</label><br>
													<form:input type="text" path="name" id="name" class="form-control"
														placeholder="Enter Room Name" value="${group.name}"/>
													<br><form:errors path="name"/><br>													
	                                        	</div>
                                        		<div class="form-group">
													<label for="email" class="form-control-label">Email:</label><br>
													<form:input type="text" path="email" id="email" class="form-control"
														placeholder="Enter Email" value="${group.email}"/>
